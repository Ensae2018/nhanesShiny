    ...
    sidebarLayout(
      ...
      mainPanel(
        conditionalPanel(condition="input.idRadioC == 1",
                         ...
                         br(),
                         h4("3) Choix du seuil de discrimination offrant le meilleur compromis de performance pour le test de dépistage (point optimum courbe ROC).",align="left"),
                         br(),
                         h4("4) Modèle de régression logistique retenu pour son côté explicatif et sa méthode de sélection des variables.",align="left"),
                         br(),
                         h4("5) Les variables de discrimination cohérentes par rapport à notre recherche bibliographique sur les maladies.",align="left"),
                         br()),
